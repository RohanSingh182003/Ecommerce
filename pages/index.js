...
export default function Home() {
  return (
    <div>
      <Head>
        <title>Ecommerce | Order what you want , when you want at low price</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

{/* Image starts Here */}
<div className="image w-full pt-2 md:pt-0 bg-gray-50">
  <img src={'/bg.jpg'} className='lg:mx-auto'/>
</div>
...
<section className="text-gray-600 body-font">
  <div className="container px-5 py-10 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      ...
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Buy all the things you want at low price. What you want , When you want.</p>
    </div>
